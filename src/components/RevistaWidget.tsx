...
export default function RevistaWidget() {
  return (
    <motion.div
      whileHover={{ y: -2 }}
      className="bg-white rounded-xl border border-border/50 overflow-hidden cursor-pointer group transition-shadow hover:shadow-lg hover:shadow-primary/5"
    >
      <div className="h-28 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/5 relative flex items-center justify-center overflow-hidden">
        ...
        <div className="relative flex items-center gap-3">
          <div className="w-14 h-18 bg-white rounded-lg shadow-lg shadow-primary/10 flex items-center justify-center border border-border/30">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-primary">Revista C.Vale</p>
