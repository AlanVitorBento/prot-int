    ...
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border border-amber-200/50 p-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-sm text-text">Clima — Palotina, PR</h3>
        </div>
      </div>
      <div className="flex items-center gap-4 mb-3">
        <span className="text-3xl font-light text-text">24°C</span>
        <div>
      ...
      <div className="grid grid-cols-2 gap-2">
        {[
          ...
          <div key={item.label} className="flex items-center gap-2 bg-white/60 rounded-lg p-2">
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg hover:bg-white/10 transition-colors text-white/60"
      >
